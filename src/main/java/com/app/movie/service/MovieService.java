...
public class MovieService {
    ...
    public MovieService() {
        ...
        movieList.add(new Movie(7,
                "https://m.media-amazon.com/images/I/91vIHsL-zjL.jpg", "Interstellar", "8/10", "2011", 1.30));
        movieList.add(new Movie(8,
